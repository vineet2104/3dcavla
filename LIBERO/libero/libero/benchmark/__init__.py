...
class Benchmark(abc.ABC):
    ...
    def _make_benchmark(self):
        ...
        if self.name == "libero_80" or self.name=="libero_80_cotdep" or self.name=="libero_80_cot" or self.name=="libero_80_dep":
            self.tasks = tasks
        elif self.name == "libero_unseen2":
            self.tasks = tasks
        else:
...
@register_benchmark
class LIBERO_UNSEEN(Benchmark):
    def __init__(self, task_order_index=0):
        super().__init__(task_order_index=task_order_index)
        self.name = "libero_unseen"
        self._make_benchmark()

@register_benchmark
class LIBERO_UNSEEN2(Benchmark):
    def __init__(self, task_order_index=0):
        super().__init__(task_order_index=task_order_index)
        self.name = "libero_unseen2"
        self._make_benchmark()

@register_benchmark
class LIBERO_GOAL_COTDEP(Benchmark):
    def __init__(self, task_order_index=0):
        super().__init__(task_order_index=task_order_index)
        self.name = "libero_goal_cotdep"
        self._make_benchmark()

@register_benchmark
class LIBERO_10_COTDEP(Benchmark):
    def __init__(self, task_order_index=0):
        super().__init__(task_order_index=task_order_index)
        self.name = "libero_10_cotdep"
        self._make_benchmark()

@register_benchmark
class LIBERO_SPATIAL_COTDEP(Benchmark):
    def __init__(self, task_order_index=0):
        super().__init__(task_order_index=task_order_index)
        self.name = "libero_spatial_cotdep"
        self._make_benchmark()

@register_benchmark
class LIBERO_OBJECT_COTDEP(Benchmark):
    def __init__(self, task_order_index=0):
        super().__init__(task_order_index=task_order_index)
        self.name = "libero_object_cotdep"
        self._make_benchmark()
